...
public class ExportExcelUtil {
	 ...
	 * @return
	 */
	public static File exportExcel(HttpServletResponse response, String[] headers, List<String> list,String title) {

		// 创excel工作簿
		HSSFWorkbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet();
		//样式
		sheet.setDefaultColumnWidth(39);//行宽 
		// 创建第一行
		Row firstRow = sheet.createRow(0);
		//行高
		firstRow.setHeightInPoints(39);  
