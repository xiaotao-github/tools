...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/staticfile/student/css/experimentDetail_v3.css">
</head>
<body>
	<div class="uploadPart">
		...
		<div class="laboratory-container">
			<div class="inner clearfix">
				<div class="pd-10 pt-30 pb-30 clearfix pos-r">
										...
										<c:if test="${not empty experimentTemplate.content }">
											...
											<div class="row cl mt-20">
												...
												<div class="formControls col-xs-9 col-sm-10 col-lg-11">
													...
													<c:if test="${not empty experimentTemplate.content }"><div class="mt-5"><span class="selImg-btn btn btn-primary radius">获取实验图像</span><p class="c-red">点击选中可将实验硬件(示波器、万用表)等图像结果存入实验过程中，未选中的图像将在刷新时清理。</p></div></c:if>
												</div>
											</div>
	...
	<c:if test="${not empty experimentTemplate.content }">
	<iframe src="${ctx }/page/student/toolPart" id="toolIframe" class="box-shadow radius"></iframe>

	<div class="frameSlideBtn pos-f radius box-shadow"><span>获取数据</span></div>
	</c:if>
...
<script type="text/javascript">
	...
	var experimentId ="${experiment.experimentId}";//实验ID
...
<script type="text/javascript">
	...
	function getImgData(ele){
		$('.dataGetting-img').append(ele);
		layer.msg('已生成图片,可以点击实验图片按钮获取!');
	}
	
</script>
<script type="text/javascript" src="${ctx}/staticfile/student/js/experimentDetail_v3.js"></script>
<script type="text/javascript" src="${ctx}/staticfile/student/js/list_v2.js"></script>
<script>
