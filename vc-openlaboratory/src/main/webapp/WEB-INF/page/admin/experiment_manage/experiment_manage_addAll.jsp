...
<body>
	...
	<form  action="${ctx }/experimentController/addExperiment" method="post" class="form form-horizontal" id="form-experimentManage-add">
		...
		<div class="row cl">
			...
			<div class="row cl">
				...
				<!-- <div class="row cl">
					...
					<p class="col-xs-9 col-sm-9 text-r"><span class="submitBtn btn btn-primary radius">添加实验</span></p>
				</div> -->
			</div>
		</div>
	</form>
