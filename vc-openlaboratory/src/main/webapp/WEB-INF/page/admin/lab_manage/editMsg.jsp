...
<body>
	<div class="page-container">
		<form class="form form-horizontal upLoadBanner">
			...
			<input type="hidden" name="labId" value="${notice.labId }"/>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">标题：</label>
				<div class="formControls col-xs-9 col-sm-9">
					<input type="text" class="input-text" placeholder="请输入公告标题" id="" name="title" value="${notice.title }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2">公告内容：</label>
				<div class="formControls col-xs-9 col-sm-9">
					<textarea name="content" cols="" rows="" class="textarea" placeholder="请输入公告内容.." datatype="*" dragonfly="true" onkeyup="$.Huitextarealength(this,500)">${notice.content }</textarea>
				</div>
			</div>
			<div class="row cl">
