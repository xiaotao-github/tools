...
<body>
	...
	<form  action="${ctx}/labClassCardWebVideoController/addVideoFiles" 
			...
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2"><span class="c-red pr-5">*</span>视频描述：</label>
				<div class="formControls col-xs-9 col-sm-9">
					<textarea name="pvDescribe" cols="" rows="" class="textarea" placeholder="" datatype="*" dragonfly="true" onkeyup="$.Huitextarealength(this,500)"></textarea>
				</div>
			</div>
					...
					<div class="uploader-list-container"> 
						<div class="queueList">
							<div id="dndArea" class="placeholder">
								...
								<p>或将视频拖到这里，每次只可上传一个视频，只能上传flv,mp4,mov,wmp格式视频</p>
							</div>
						</div>
...
var ctx = "${ctx}";
 ...
 <script type="text/javascript"src="${ctx }/staticfile/js/uploadVideo.js"></script> 
<script>
$("#form-myself-upload-resource-edit").Validform({
	...
	beforeSubmit:function(curform){
		...
		var pvDescribe = $('.textarea[name=pvDescribe]').val();
		
		uploader.options.formData = {
				'labId':filelabId,
				'title':fileTitle,
				'pvDescribe':pvDescribe,
		}
