...
<div class="page-container">
	<form action="${ctx}/semesterController/modifySemester" method="post"   id="form-termManage-add" class="form">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<div>
					<input type="text" class="input-text" value="${semester.semesterName }" placeholder="请填写课程名称！" id="semesterName" name="semesterName" datatype="*" nullmsg="请输入学期名称！" errormsg="课程名称不可用！请重新输入"  ajaxurl="${ctx}/semesterController/validateSemester/${semester.semesterId}">
				</div>
				<div class="cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<div>
					<input type="text" value="${semester.startTimeToString }" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endTime\')}'})" id="starTime" class="input-text Wdate" placeholder="学期开始时间!" id="param" name="startTime"  datatype="*" nullmsg="请选择学期开始时间" value="<%=value %>">
				</div>
				<div class="cl">
					<span class="Validform_checktip"></span>
				</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<div>
					<input type="text" value="${semester.endTimeToString }" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'starTime\')}'})" id="endTime" class="input-text Wdate" placeholder="学期结束时间!" id="param" name="endTime"  datatype="*" nullmsg="请选择学期结束时间" value="<%=value %>">
				</div>
				<div class="cl">
					<span class="Validform_checktip"></span>
				</div>
