...
<body>
	<div class="page-container">
		<form action="" method="post" enctype="multipart/form-data" class="form" id="machineUserAdd-form">
			<div class="row cl">
			...
			<div class="row cl">
				<label class="col-xs-3 col-sm-3 pn-0 text-r"><span class="c-red pr-5">*</span>所属班级：</label>
				<div class="formControls col-xs-8 col-sm-8"> 
					<div>
						<select name="labId" datatype="*" class="select select-box" id="labSelect" nullmsg="请选择所属实验室！" errormsg="请选择所属实验室！">
						</select> 
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-8">
					<div>
						<input type="text" class="input-text" value="" placeholder="请输入考勤机ID!" id="" name="number"  datatype="*" nullmsg="请输入考勤机ID">
					</div>
					<div class="cl">
						<span class="Validform_checktip"></span>
					</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-8">
					<div>
						<input type="text" class="input-text" value="" placeholder="请输入考勤机名称!" id="param" name="courseName" datatype="*" nullmsg="请输入考勤机名称!">
					</div>
					<div class="cl">
						<span class="Validform_checktip"></span>
					</div>
			...
			<div class="row cl">
				<div class="col-xs-12 col-sm-12 text-c">
					<button class="btn btn-primary radius" type="button" id="machineUserAddSub"><i class="Hui-iconfont">&#xe600;</i>添加</button>
					<button class="btn radius" type="button" id="machineUserAddReset">重置</button>
				</div>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript" src="${ctx }/staticfile/js/studentAttendanceManage/machineUserAdd.js"></script>
</html>