...
<body>
	<div class="page-container">
		<form action="/labClockInManageController/editMachine" method="post" enctype="multipart/form-data" class="form" id="machineEdit-form">
			<input type="hidden"  value="${machine.id }"  id="" name="id"  >
			<input type="hidden"  value="${machine.clockinId }"  id="" name="clockinId"  >
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-8">
					<div>
						<input type="text" class="input-text" value="1111" placeholder="请输入考勤机ID!" id="" name="number"  datatype="*" nullmsg="请输入考勤机ID">
					</div>
					<div class="cl">
						<span class="Validform_checktip"></span>
					</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-8">
					<div>
						<input type="text" class="input-text" value="${machine.fkName }" placeholder="请输入考勤机名称!" id="param" name="name" datatype="*" nullmsg="请输入考勤机名称!"
						errormsg="考勤机名称不可用！请重新输入" ajaxurl="${ctx }/labClockInManageController/vaildateNameWithFkName/?fkName=${machine.fkName }">
					</div>
					<div class="cl">
						<span class="Validform_checktip"></span>
					</div>
			...
			<div class="row cl">
				<div class="col-xs-12 col-sm-12 text-c">
					<button class="btn btn-primary radius" type="button" id="machineEditSub"><i class="Hui-iconfont">&#xe600;</i>添加</button>
					<button class="btn radius" type="button" id="machineEditReset">重置</button>
				</div>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript" src="${ctx }/staticfile/js/studentAttendanceManage/machineEdit.js"></script>
</html>