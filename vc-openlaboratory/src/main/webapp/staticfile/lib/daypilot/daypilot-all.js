	...
	if ("undefined" == typeof DayPilot.Calendar) {
		DayPilot.Calendar = function(t, i) {
			...
			this.eventResizePostBack = function(e, t, i, n) {
				...
				var n = document.createElement("div");
				return n.style.position = "absolute", n.style.padding = "2px", n.style.top = "0px", n.style.left = "1px", n.style.backgroundColor = "none", n.style.color = "white", n.innerHTML = "", n.setAttribute("unselectable", "on"), DayPilot.Util.isNullOrUndefined(undefined) && e.appendChild(n), e
			}, this.N = function() {
				var e = this.nav.main;
		...
		DayPilot.Month = function(i, n) {
			...
			this.Fe = function() {
				...
				if (!DayPilot.contains(this.nav.top.childNodes, r) && DayPilot.Util.isNullOrUndefined(undefined)) {
					var f = document.createElement("div");
					f.style.position = "absolute", f.style.padding = "2px", f.style.top = "0px", f.style.left = "0px", f.style.backgroundColor = "none", f.style.color = "white", f.innerHTML = "", r = f, this.nav.top.appendChild(f)
				}
			}, this.Ee = function() {
	...
	if ("undefined" == typeof DayPilot.Scheduler) {
		...
		DayPilot.Scheduler = function(e, o) {
			...
			this.visibleStart = function() {
				...
				var a = document.createElement("div");
				a.style.position = "absolute", a.style.padding = "2px", a.style.top = "0px", a.style.left = "1px", a.style.backgroundColor = "none", a.style.color = "white", a.innerHTML = "", DayPilot.Util.isNullOrUndefined(undefined) && e.appendChild(a)
			}, this.qk = function() {
				var e = 3,
