...
<%@ page import=" java.sql.*,java.util.*,java.io.*,com.vcooc.common.util.CookieUtils" errorPage=""%>
...
<%
	...
	try {
		...
		String p1 = CookieUtils.getCookieValue(request, "FILE_PATH");//获取配置文件中设置的图片上传路径
