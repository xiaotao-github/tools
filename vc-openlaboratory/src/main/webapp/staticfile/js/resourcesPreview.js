...
$(function(){
	$.getJSON(url,function(sysresult){
		...
		if(sysresult.status == 200){
			//资源标题
			var sysresult=sysresult.data.file;
					...
					if(fileType=='jpg' || fileType=='png' || fileType=='jpeg' || fileType=='bmp' || fileType=='gif'){
						...
						if(resourceFileType == 'swf'){
							content='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,16,0" width="780" height="500" >'+
									...
									'<embed style="margin-left:-10px;" src="'+url+'" width="780" height="500" play="true" loop="false" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash">'+ 
									'</embed>'+
								'</object>';
							$(".resourceBox").html(content);
						}else{
				    	...
				    	if(explorer.indexOf("chrome") >= 0){
							content='<div style="width:780px;height:auto;margin-left:-10px;position:relative;margin:0 auto;"><embed id="pdfPlayer" src="'+url+'" type="application/pdf" width="780px" height="500px" style=""><div style="width:682px;position:absolute;right:18px;top:0;height:55px;background:#525659;"></div></div>'; 
				    	}
				    	else if(explorer.indexOf("firefox") >= 0){
							content='<div style="width:780px;height:auto;margin-left:-10px;position:relative;margin:0 auto"><embed id="pdfPlayer" src="'+url+'" type="application/pdf" width="780px" height="500px" style=""><div style="width:40px;position:absolute;right:0;top:0;height:30px;background:#454545;"></div></div>'; 
				    	}
				    	else{
		 			    	content='<object classid="clsid:CA8A9780-280D-11CF-A24D-444553540000" width="800" height="500" border="0" style="margin-left:-10px;">'+ 
