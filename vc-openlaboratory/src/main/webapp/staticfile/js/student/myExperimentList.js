...
function initReserveBox(data){
	...
	o.attr('data-href',ctx+'/studentController/getCourseScheduleList/'+data.scheduleId+'/'+data.studentId+'/'+data.experimentId+'/'+data.labId)
	...
	o.find('.course_type').html(data.course_type);
